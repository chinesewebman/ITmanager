...
interface AlertState {
  alerts: Alert[]
  stats: { total: number; problem: number; acknowledged: number; resolved: number }
  loading: boolean
  filters: { status?: string; severity?: string }
  setAlerts: (alerts: Alert[]) => void
  setStats: (stats: { total: number; problem: number; acknowledged: number; resolved: number }) => void
  setLoading: (loading: boolean) => void
...
interface AssetState {
  ...
  setLoading: (loading: boolean) => void
  setFilters: (filters: { site_id?: string; type?: string; status?: string }) => void
}
